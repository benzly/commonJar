...
public final class Types {
    ...
    static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
        ...
        return resolve(context, contextRawType, Types.getGenericSupertype(context, contextRawType, supertype));
    }
    ...
    public static Type getArrayComponentType(Type array) {
        return array instanceof GenericArrayType ? ((GenericArrayType) array).getGenericComponentType() : ((Class<?>) array)
                .getComponentType();
    }
