...
public final class JsonPrimitive extends JsonElement {
    ...
    private static final Class<?>[] PRIMITIVE_TYPES = {int.class, long.class, short.class, float.class, double.class, byte.class,
            boolean.class, char.class, Integer.class, Long.class, Short.class, Float.class, Double.class, Byte.class, Boolean.class,
            Character.class};
    ...
    /**
     * Create a primitive containing a character. The character is turned into a one character
     * String since Json only supports String.
     *
    ...
    private static boolean isIntegral(JsonPrimitive primitive) {
        if (primitive.value instanceof Number) {
            ...
            return number instanceof BigInteger || number instanceof Long || number instanceof Integer || number instanceof Short
