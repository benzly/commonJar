 ...
 *
 * <p>
 * Let us look at example where defining a serializer will be useful. The {@code Id} class defined
 * below has two fields: {@code clazz} and {@code value}.
 * </p>
 *
 * <p>
 * 
...
public interface JsonSerializer<T> {
     ...
     * any non-trivial field of the {@code src} object. However, you should never invoke it on the
