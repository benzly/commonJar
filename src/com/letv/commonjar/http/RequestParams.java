...
//    	map.put(key, value);
     ...
     */
    public HttpEntity getEntity(ResponseInterface progressHandler) throws IOException {
    ...
    private HttpEntity createMultipartEntity(ResponseInterface progressHandler) throws IOException {
