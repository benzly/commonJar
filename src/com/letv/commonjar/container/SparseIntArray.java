 ...
 * the indices. It is intended to be more memory efficient than using a HashMap to map Integers to
 * Integers, both because it avoids auto-boxing keys and values and its data structure doesn't rely
