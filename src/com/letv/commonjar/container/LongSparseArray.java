 ...
 * {@link android.util.LongSparseArray} that can be used on older versions of the platform. Unlike a
 * normal array of Objects, there can be gaps in the indices. It is intended to be more memory
 * efficient than using a HashMap to map Longs to Objects, both because it avoids auto-boxing keys
 ...
 * be grown or the the map size or entry values are retrieved.
 * </p>
 */
public class LongSparseArray<E> implements Cloneable {
     ...
     * <code>index</code>th key-value mapping that this LongSparseArray stores.
     */
