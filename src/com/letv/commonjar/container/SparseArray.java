...
public class SparseArray<E> implements Cloneable {
     ...
     * allocation to store the specified number of mappings. If you supply an initial capacity of 0,
     * the sparse array will be initialized with a light-weight representation not requiring any
     ...
     * <p>
     * Note also that unlike most collections' {@code indexOf} methods, this method compares values
     * using {@code ==} rather than {@code equals}.
     */
