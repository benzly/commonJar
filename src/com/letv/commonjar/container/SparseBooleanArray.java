 ...
 * to Booleans, both because it avoids auto-boxing keys and values and its data structure doesn't
...
public class SparseBooleanArray implements Cloneable {
    ...
    /**
     * Creates a new SparseBooleanArray containing no mappings that will not require any additional
    ...
    /**
     * Gets the boolean mapped from the specified key, or <code>false</code> if no such mapping has
     * been made.
     */
    ...
    /**
     * Gets the boolean mapped from the specified key, or the specified value if no such mapping has
     * been made.
     */
     ...
     * <code>index</code>th key-value mapping that this SparseBooleanArray stores.
     *
     * <p>
