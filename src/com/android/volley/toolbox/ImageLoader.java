 ...
 * class must be made from the main thead, and all responses will be delivered to the main thread as
 * well.
 */
public class ImageLoader {
    ...
    public interface ImageListener extends ErrorListener {
         ...
         *        used to differentiate between a cached image loading and a network image loading
         *        in order to, for example, run an animation to fade in network loaded images.
         */
        public void onResponse(ImageContainer response, boolean isImmediate);
    }
